...
- В приложение доступна строка поиска. **Поиск** осуществляется по всем данным. Отрисовка найденных элементов, где содержится введенный текст, происходит моментально. Кроме ввода текста в поле *input* ничего нажимать не надо. 
